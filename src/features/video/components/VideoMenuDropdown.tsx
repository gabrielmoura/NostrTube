...
import { VideoMetricsModal } from '@/features/video/components/VideoMetricsModal'
...
export function VideoMenuDropdown({ event }: { event: NDKEvent }) {
  ...
  return (
    <>
        ...
        <DropdownMenu.Portal>
          ...
          >
            ...
            >
              ...
              <span>{t('video_metrics.modal_title')}</span>
            </DropdownMenu.Item>
      ...
      <VideoMetricsModal open={metricsOpen} onOpenChange={setMetricsOpen} event={event} />
    </>
  )
}
