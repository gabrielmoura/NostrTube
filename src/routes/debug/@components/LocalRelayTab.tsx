...
import { fetchNip11, type Nip11Info, pingRelay } from '@/features/debug/services/error-log.service.ts'
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader
          title="Relay Local"
          icon={Wifi}
          description="Conecte a um relay Nostr local para desenvolvimento e testes."
        />
            ...
            >
              ...
              {nip11 && (
                <div className="text-xs text-zinc-600 dark:text-zinc-400 space-y-1 mt-2 pt-2 border-t border-zinc-200 dark:border-zinc-700">
                  {nip11.name && (
                    <p>
                      <strong>Nome:</strong> {nip11.name}
                    </p>
                  )}
                  {nip11.description && (
                    <p>
                      <strong>Descricao:</strong> {nip11.description}
                    </p>
                  )}
                  {nip11.software && (
                    <p>
                      <strong>Software:</strong> {nip11.software} {nip11.version ?? ''}
                    </p>
                  )}
                  {nip11.supported_nips && (
                    <p>
                      <strong>NIPs suportados:</strong> {nip11.supported_nips.sort((a, b) => a - b).join(', ')}
                    </p>
                  )}
                </div>
              )}
