...
function RouteComponent() {
  return (
    <AppShell
      title="Termos de Uso"
      description="Última atualização: Janeiro de 2026"
      icon={ShieldCheck}
      eyebrow="Policies"
      badge="Legal & Trust"
    >
      <div className="mx-auto max-w-3xl">
        <div className="mb-10 rounded-3xl border border-border/70 bg-gradient-to-br from-card/90 via-card/70 to-primary/5 p-6 shadow-sm">
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-amber-500/20 bg-amber-500/10 p-4 text-sm leading-relaxed text-card-foreground">
            ...
            <p>
              <strong>Atenção:</strong> Este documento é um modelo informativo e não substitui a revisão por um
          ...
          <div className="space-y-10">
            <section id="descricao">
              ...
              <p className="leading-relaxed text-muted-foreground">
                ...
                compartilhamento de vídeos construída sobre o protocolo{' '}
                <strong className="text-foreground">Nostr</strong>, que utiliza uma rede descentralizada de servidores
                (relays) para armazenar e distribuir conteúdo. Não existe um servidor central que controle todo o
                conteúdo; a plataforma indexa e apresenta informações publicamente disponíveis nos relays.
              </p>
            </section>
            ...
            <section id="responsabilidade">
              ...
              <p className="leading-relaxed text-muted-foreground">
                ...
                plataforma ou do protocolo Nostr. Isso inclui garantir que possui direitos sobre o material e
                compreender que o conteúdo pode ser replicado em diversos relays.
              </p>
              <p className="mt-3 leading-relaxed text-muted-foreground">
                Devido à natureza descentralizada, não é possível garantir a exclusão completa ou a retirada definitiva
                de conteúdos já publicados na rede Nostr.
              </p>
            </section>
            ...
            <section id="privacidade">
              ...
              <p className="mt-3 leading-relaxed text-muted-foreground">
                ...
                comentários ou perfis, pois esses dados podem ser replicados e arquivados permanentemente por terceiros.
              </p>
            </section>
            ...
            <section id="alteracoes">
              ...
              <p className="leading-relaxed text-muted-foreground">
                ...
                documento. O uso contínuo da plataforma após alterações implica aceitação dos Termos atualizados.
              </p>
            </section>
            ...
            <section id="encerramento">
              ...
              <p className="leading-relaxed text-muted-foreground">
                Você pode deixar de usar a plataforma a qualquer momento. A remoção do seu perfil local na plataforma
                não implica na exclusão dos dados já publicados nos relays, que permanecem públicos em função do
                protocolo Nostr.
              </p>
            </section>
