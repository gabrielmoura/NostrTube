import { AlertCircle, Check, ChevronDown, Eye, EyeOff, Shield, UserCheck } from 'lucide-react'
...
export const VisibilitySettings = () => {
  ...
  return (
    <Card className="overflow-hidden">
      <CardHeader title={t('visibility.title')} icon={Shield} />
