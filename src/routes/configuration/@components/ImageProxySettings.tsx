...
import { type ImageProxyMode, useImageProxySettingsStore } from '@/store/useImageProxySettingsStore.ts'
...
export function ImageProxySettings() {
  ...
  return (
    <Card>
      <CardHeader title={t('image_proxy.title')} description={t('image_proxy.description')} icon={ImageIcon} />
        ...
        <div className="grid gap-4 sm:grid-cols-[minmax(0,220px)_1fr]">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={
                imageProxy.mode === 'imageproxy' ? 'https://example.com/api/imageproxy' : 'https://imgproxy.example.com'
              }
