...
export default function VideoUploadFile() {
  ...
  return (
    <div className="relative flex min-h-[420px] w-full flex-col justify-center gap-4 overflow-hidden rounded-3xl bg-secondary/20 p-4">
      ...
      <Button onClick={() => setShowEventInput(true)} variant="glass" className="relative mx-auto">
