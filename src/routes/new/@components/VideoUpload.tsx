...
export function VideoUpload({
    ...
    if (showEventInput) {
        return (
            <div
                className="center relative aspect-video h-full w-full flex-col gap-y-2 overflow-hidden rounded-md bg-muted">
    ...
    return (
        <div
            className="center relative aspect-video h-full w-full flex-col gap-y-3 overflow-hidden rounded-md bg-muted">
            <button
                onClick={() => {
                    // modal.show(
                    //   <UploadModal
