 ...
 */
export const generateVideoThumbnail = (file: File, options: ThumbnailOptions = {}): Promise<string> => {
...
export function generateVideoThumbnailFromUrl(url: string, options: ThumbnailOptions = {}): Promise<string> {
  return new Promise((resolve, reject) => {
    ...
    video.addEventListener('error', (e) => {
      ...
      reject(
        new VideoThumbnailError(
          'Erro ao carregar o vídeo. A URL pode estar incorreta ou o vídeo pode estar inacessível.',
        ),
      )
    })
