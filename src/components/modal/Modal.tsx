...
import type {ModalT, ToasterProps, ToastToDismiss} from "@/components/modal/types.ts";
import {ModalState} from "@/components/modal/state.tsx";
import {Dialog, DialogContent, DialogOverlay, DialogPortal} from "@/components/modal/Dialog.tsx";
import {Drawer, DrawerContent, DrawerNestedRoot} from "@/components/modal/Drawer.tsx";
...
export const Modstr = (props: ToasterProps) => {
