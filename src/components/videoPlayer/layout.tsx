...
export function VideoLayout({ thumbnails, persistentProgress }: VideoLayoutProps) {
  return (
    <div>
      <BufferingIndicator />
      <Gestures />
      ...
      >
        ...
        <Controls.Group className="-mt-0.5 flex w-full items-center justify-between overflow-hidden border-t border-white/10 bg-black/45 px-1 pb-1 shadow-[0_-8px_24px_rgba(0,0,0,0.25)] backdrop-blur-md">
          ...
          <div className="flex gap-x-1">
            <MenuCaptions offset={popupOffset} tooltipOffset={popupOffset} />
            <GoogleCast tooltipOffset={popupOffset} />
            <PIP tooltipOffset={popupOffset} />
            <Fullscreen tooltipOffset={popupOffset} />
          </div>
        </Controls.Group>
      </Controls.Root>
    </div>
