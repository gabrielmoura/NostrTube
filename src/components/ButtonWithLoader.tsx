      ...
      >
        {isLoading ? (
          <>
            ...
            {/* Se houver loadingText, exibe ele. Se não, exibe o children original para manter contexto,
                ou você pode optar por renderizar apenas o Spinner se quiser um botão menor. */}
