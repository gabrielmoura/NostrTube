  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        gradient: 'brand-gradient brand-glow text-white shadow-lg hover:brightness-105',
        zap: 'bg-[oklch(var(--lightning))] text-black hover:brightness-95',
        relay: 'bg-[oklch(var(--relay-cyan))] text-[oklch(0.16_0.014_250)] hover:brightness-95',
        glass:
          'border border-border/70 bg-card/60 text-foreground backdrop-blur-xl hover:bg-card/80 hover:border-primary/40',
        dangerSoft:
          'border border-destructive/40 bg-destructive/12 text-destructive hover:bg-destructive/18 hover:border-destructive/55',
        destructive:
